...
APPROACH1  = list(range(12, 25))     # 12-24
APPROACH2  = list(range(25, 42))     # 25-41
TAIL       = list(range(42, 52))     # 42-51, merge-only, not in either part
...
def do_split(src_path):
    ...
    save(part_a, "support_routing_partA_encoders.ipynb")
    save(part_b, "support_routing_partB_slms.ipynb")
    print("wrote support_routing_partA_encoders.ipynb (cells 0-11,12-24)")
    print("wrote support_routing_partB_slms.ipynb (cells 0-11,25-41)")
